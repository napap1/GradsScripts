...
********************** Titels & opmaak ****************************
'set strsiz 0.18'
'set string 1 r 12 0' ; 'draw string 10.95 8.3 Mean sea layer pressure (mb) & 500mb geopotential height (m)'
...
'set strsiz 0.12'
'set string 1 r 3 270' ; 'draw string 0.15 0.35 <- mb, higher means increasing surface pressure reduced to MSL ->'

'set strsiz 0.10'
'set string 1 r 4 0' ; 'draw string 10.95 7.85 MSLP: Dashed contours each 1mb, Thick dashed contours each 4mb'
...
* opslag
********
'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.1.a2.oga.1\i686\mslp_eur_'i'_valid_'hub'_run_'huh'.png x1024 y768'
