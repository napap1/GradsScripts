...
* Colortable
************
'color.gs 0 1 0.05 -gxout shaded -kind (60,60,60)->(25,200,230)'

*******************************************************************
********************** Titels & opmaak ****************************
'set strsiz 0.18'
'set string 1 r 12 0' ; 'draw string 10.95 8.3 Precipitation type: Frz rain, MSLP (mb) & 0deg 2m-isotherm (Celsius)'
'set strsiz 0.10'
...
'set strsiz 0.12'
'set string 1 r 3 270' ; 'draw string 0.15 0.35 <- Higher means increasing chance for frz rain as precip-type ->' 

'set strsiz 0.10'
'set string 1 r 4 0' ; 'draw string 10.95 7.85 MSLP: Dashed contours each 1mb, Thick contours each 4mb'
'set string 1 r 4 0' ; 'draw string 10.95 7.65 0deg temperature: Dashed white contour'
...
* opslag
********
'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.1.a2.oga.1\i686\frzrain_eur_'i'_valid_'hub'_run_'huh'.png x1024 y768'
