...
'define shearangle= 270-atan2(usheardls,vsheardls)*(180/pi)'
...
'define mwangle= 270-atan2(umean,vmean)*(180/pi)'
...
*'define bep=((cape180_0mb)/1500)*(lapse/6)*(((-5/18)*anglediff+100)/100)*(meanwindul/10)*(sheardls/10)'
'define bep=((cape180_0mb)/1500)*(lapse/6)*(-0.01111*anglediff+1)*(meanwindul/10)*(sheardls/10)'
*'define bepcos=((cape180_0mb)/1500)*(lapse/6)*cos(anglediff)*(meanwindul/10)*(sheardls/10)'

'define angleterm = (-0.01111*anglediff+1)'
'd bep'
