...
* Colortable
************
'color.gs 0 200 2 -gxout shaded -kind (255,255,255)->(217,217,217)->(178,178,178)->(139,139,139)->(100,100,100)->(50,140,50)->(0,180,0)->(127,217,0)->(255,255,0)->(189,128,0)->(122,0,0)->(188,0,127)->(255,0,255)->(222,0,255)->(189,0,255)->(155,0,255)->(121,0,255)->(92,0,193)->(62,0,131)->(33,0,69)->(0,0,0)'
...
'set strsiz 0.10'
'set string 1 r 4 0' ; 'draw string 10.95 7.85 Maximum windgusts: White dashed contours each 10km/hr, starting at 70 km/hr'
