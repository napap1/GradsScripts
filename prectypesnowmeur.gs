...
* Colortable
************
'color.gs 0 1 0.05 -gxout shaded -kind (60,60,60)->(255,180,255)'
...
'set string 1 r 4 0' ; 'draw string 10.95 7.65 0deg dewpoint: Dashed white contour'
...
* opslag
********
'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.1.a2.oga.1\i686\snow_meur_'i'_valid_'hub'_run_'huh'.png x1024 y768'
