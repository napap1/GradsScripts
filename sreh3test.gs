...
'set string 1 r 4 0' ; 'draw string 10.95 7.85 SCP: Thick white contours each increment by 1, >=1 is conducive to supercel updraft rotation'
'set string 1 r 4 0' ; 'draw string 10.95 7.65 STP: Thick black contours each increment by 1, >=1 is conducive to tornadic development'
