...
'set rgb 124 0 234 236'
'set rgb 125 1 223 216'
'set rgb 126 1 212 197'
'set rgb 127 2 201 177'
'set rgb 128 2 190 157'
'set rgb 129 3 179 138'
'set rgb 130 3 167 118'
'set rgb 131 4 156 99'
'set rgb 132 4 145 79'
'set rgb 133 5 134 59'
'set rgb 134 5 123 40'
'set rgb 135 6 112 20'
'set rgb 136 28 125 19'
'set rgb 137 51 138 17'
'set rgb 138 73 151 15'
'set rgb 139 96 164 13'
'set rgb 140 119 177 11'
'set rgb 141 141 190 10'
'set rgb 142 164 203 8'
'set rgb 143 187 216 6'
'set rgb 144 209 229 4'
'set rgb 145 232 242 2'
...
********************** Titels & opmaak ****************************
'set strsiz 0.18'
'set string 1 r 12 0' ; 'draw string 10.95 8.3 850mb Theta-E & 500mb Geopotential height (m), LL relvort & MSLP'
...
'set strsiz 0.10'
'set string 1 r 4 0' ; 'draw string 10.95 7.85 MSLP: Dashed white contours each 1mb, Clear white contours each 4mb'
'set string 1 r 4 0' ; 'draw string 10.95 7.65 925-850mb Relative vorticity: White contours each 0.5*10E-5/s'
'set string 1 r 4 0' ; 'draw string 10.95 7.45 500mb geopotential height: Thick black contours each 60 meter'
'set string 1 r 4 0' ; 'draw string 10.95 7.25 850mb Theta-E: Black contours each 1deg'
...
* opslag
********
'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.1.a2.oga.1\i686\thetaEv2_eur_'i'_valid_'validvar'_run_'runvar'.png x1024 y768'
