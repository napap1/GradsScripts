...
* visualisatie 300-200mb isotachs
*****************************
'define u300 = ugrdprs(lev=300)'
'define v300 = vgrdprs(lev=300)'
'define ws300 = sqrt(u300*u300 + v300*v300)'
'define u250 = ugrdprs(lev=250)'
'define v250= vgrdprs(lev=250)'
'define ws250 = sqrt(u250*u250 + v250*v250)'
'define windspeed = (ws300 + ws250)/2'
...
'set strsiz 0.18'P
'set string 1 l 12 0' ; 'draw string 0.15 8.3 700mb RH(%), Theta-E(C), 500mb GPM & Isotachs (>50kts)'

'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.0.2.oga.2\i686\rh700thetae'i'.png x1024 y768'
