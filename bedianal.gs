...
'define bep=((capesfc/100)*(shear3km/20)*(mw850700/25)*(meanwind/25)*(lapse/5))'
...
'd skip(maskout((usheardls*1.943844),bep-1),1,1); vsheardls*1.943844'
...
'set strsiz 0.10'
'set string 4 r 4 0' ; 'draw string 10.95 8.1 Dzengiz Tafa - Analysis - `4Valid: 'validvar

* opslag
********
'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.1.a2.oga.1\i686\osbedi'i'_valid_'validvar'_Analysis.png x1024 y768'
