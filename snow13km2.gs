...
************************
'color.gs 0 100 1 -gxout shaded -kind (240,240,240)-(100)->(0,0,0)'
*'set cint 0.05'
...
'set strsiz 0.18'
'set string 1 l 12 0' ; 'draw string 0.15 8.3 Snow, Mean sea layer pressure & 0deg isotherm (2m)'

'printim C:\OpenGrADS\Contents\Cygwin\Versions\2.0.2.oga.2\i686\snow13km0'i'.png x1024 y768'
