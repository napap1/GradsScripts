...
'define u200 = ugrdprs(lev=200)'

'define v400 = vgrdprs(lev=400)'
'define v300 = vgrdprs(lev=300)'
'define v200 = vgrdprs(lev=200)'
...
'define dthetadx = cdiff(theta300,x)/dx'
'define dthetady = cdiff(theta300,y)/dy'
'define dudp = (u200-u400)/dp'
'define dvdp = (v200-v400)/dp'

'define cterm = (g*-1)*(dvdp*(dthetadx) - dudp*(dthetady))'

'define vorticity = hcurl(u300,v300)'

'define potvort = ((g*-1)*(coriolis+vorticity)*dthetadp)+cterm'

'define dpvx = cdiff(potvort,x)'
'define dpvy = cdiff(potvort,y)'


'define pvadv = -1*( u300*dpvx/dx + v300*dpvy/dy)'
