...
************
say '.Colortable'
'color.gs 100 700 5 -gxout shaded -kind (255,255,255)->(184,184,184)->(107,107,107)->(154,154,83)->(202,202,59)->(246,246,37)->(220,171,103)->(193,95,169)->(166,30,230)->(130,79,235)->(91,132,241)->(52,185,246)->(17,234,251)'

* Titles & labels
*****************
'set strsiz 0.18'
'set string 1 r 12 0' ; 'draw string 10.95 8.3 Pressure at 2 PVU, 500mb GPM, 500mb Windbarbs & CAPE/LI'
...
'set clab masked'
'set clopts -1'
'd (cape180_0mb+cape255_0mb)/2'

* Visualiatie Lifted index
**************************
say '..Lifted index'
'set gxout contour'
'set rgb 200 255 255 255 255'
'set cmax 0'
'set cint 1'
'set cstyle 3'
'set ccolor 200'
...
'set digsiz 0.05'
'set cthick 5'
'd skip(maskout((u500*1.943844),windspeed-50),3,3); v500*1.943844'
...
'set strsiz 0.10'
'set string 1 r 4 0' ; 'draw string 10.95 7.85 CAPE: Thick contours each increment by 100 J/kg, starting at 100 J/kg'
'set string 1 r 4 0' ; 'draw string 10.95 7.65 Lifted index: Dashed contours each 1degC, with a maximum of 0degC'
