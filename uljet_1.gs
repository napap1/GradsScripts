...
********************** Titels & opmaak ****************************
'set strsiz 0.18'
'set string 1 r 12 0' ; 'draw string 10.95 8.3 250-300mb Jet, streamlines, 500mb Geopotential height & MSLP'
'set strsiz 0.10'
...
'define jetspeed = (mag(u500,v500))*1.94384'
...
'set strsiz 0.12'
'set string 1 r 3 270' ; 'draw string 0.15 0.35 <----- kts, Higher means increasing upper level windspeeds ----->' 
