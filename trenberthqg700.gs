...
* Colortable
************
'color.gs -10 10 0.2 -gxout shaded -kind (255,0,255)->(215,0,229)->(174,0,202)->(133,0,176)->(92,1,149)->(52,1,123)->(11,1,96)->(43,49,135)->(75,98,175)->(107,147,215)->(156,183,228)->(204,219,241)->(255,255,255)->(254,213,171)->(253,171,87)->(251,129,2)->(213,86,2)->(174,43,1)->(135,0,0)->(155,8,8)->(175,16,16)->(195,24,24)->(215,33,33)->(235,41,41)->(255,50,50)->'

*******************************************************************
********************** Titels & opmaak ****************************
'set strsiz 0.18'
'set string 1 r 12 0' ; 'draw string 10.95 8.3 QG: Trenb Omega, 700-300mb Thickness, Thermal wind & 500mb GPM'
...
** Variables
'define h700 = smth9(smth9(smth9(hgtprs(lev=700))))'
'define h500 = smth9(smth9(smth9(hgtprs(lev=500))))'
'define h300 = smth9(smth9(smth9(hgtprs(lev=300))))'
