...
* gradsdap -l -c 'run 850mbdtemp 20170211 12'
...
* Colortable
************
'color.gs -45 30 0.5 -gxout shaded -kind (75,0,75)->(156,0,154)->(238,0,234)->(165,22,242)->(91,44,250)->(46,149,252)->(0,255,255)->(0,222,149)->(0,181,22)->(255,255,0)->(210,180,0)->(164,104,0)->(118,29,0)->(186,15,127)->(255,0,255)->(255,115,255)->(255,255,255)'
...
'set string 1 r 12 0' ; 'draw string 10.95 8.3 850mb Dewpoint temperature, Windvectors & 500mb Geopotential height'
...
'set strsiz 0.10'
'set string 1 r 4 0' ; 'draw string 10.95 7.85 500mb Dewpoint temperature: Thin contours each 0.5 degree Celsius'
